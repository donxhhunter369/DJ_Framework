...
#import "NSDictionary+DJExtension.h"
...
@implementation NSDictionary (DJExtension)
...
- (id)objectForClass:(Class)clazz
{
    ...
    for ( Class clazzType = clazz; clazzType != [NSObject class]; )
    {
        ...
        for ( NSUInteger i = 0; i < propertyCount; i++ )
        {
            ...
            NSUInteger		type = [DJTypeEncoding typeOf:attr];
            
            BOOL readonly = [DJTypeEncoding isReadOnly:attr];
            if ( readonly )
                continue;
            ...
            if ( tempValue )
            {
                ...
                {
                    NSString * className = [DJTypeEncoding classNameOfAttribute:attr];
...
@implementation NSMutableDictionary(DJExtension)
